...
Env_model1<-fit_env(tree, env_data = env_data, f.lamb = f.lamb, f.mu = f.mu, f=0.85, tot_time = 22.90199861, lamb_par = lamb_par, mu_par = mu_par, cond = "stem", dt = 1e-3, cst.mu = T,fix.mu = T, expo.lamb = T, expo.mu = T)
Env_model1
plot_fit_env(Env_model1, env, 22.90199861)
...
plot_dtt(Env_model1, tot_time = 22.90199861, N0 = 56)
